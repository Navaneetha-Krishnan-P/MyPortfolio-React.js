  ...
  return (
    <section className={styles.aboutMeContainer}>
        ...
        <div>
            ...
            <br/>
            <p>Full Stack developer with a strong foundation in HTML, CSS, JavaScript, React.js, Node.js, and MongoDB. Proficient in React and responsive design principles. Seeking to leverage my skills and passion for creating engaging user experiences to contribute to a dynamic web development team.</p>
        </div>
    </section>
  );
};
